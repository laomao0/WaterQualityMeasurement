...
void Mosbus_Init()
{
	modbus.myadd=Machine_Address;  //本从设备的地址
...
void Modbud_fun3()  //3号功能码处理  ---主机要读取本从机的寄存器
{
  ...
  modbus.Sendbuf[i++]=0x03;        //功能码，有问题就+128      
...
void Modbud_fun6()  //6号功能码处理 写入寄存器
{
  u16 Regadd;
	u16 val;
	u16 i,crc,j;
		  ...
		  switch(modbus.rcbuf[1])  //分析功能码
			{
			  ...
			  case 1:     break;
		    case 2:     break;
		    case 3:     Modbud_fun3();bsp_LedToggle(1); delay_ms(200); break;   //3号功能码处理，翻转一个LED灯指示，服务器正在传输数据
		    case 4:     break;
		    case 5:     break;
		    case 6:     Modbud_fun6();bsp_LedOn(1); delay_ms(200); break;   //6号功能码处理
	      case 7:     break;			
        //....				
			}
		}
